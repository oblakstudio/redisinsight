...
exports.default = {
    dir_path: {
        ...
        defaultGuides: (0, path_1.join)(defaultsDir, 'guides'),
    ...
    server: {
        ...
        env: 'development',
        listenInterface: (_a = process.env.RI_HOSTNAME) !== null && _a !== void 0 ? _a : '0.0.0.0',
        port: 5000,
        docPrefix: 'api/docs',
        globalPrefix: 'api',
    ...
    redis_clients: {
        idleSyncInterval: parseInt(process.env.CLIENTS_IDLE_SYNC_INTERVAL, 10) || 1000 * 60 * 60,
        maxIdleThreshold: parseInt(process.env.CLIENTS_MAX_IDLE_THRESHOLD, 10) || 1000 * 60 * 60,
    ...
    profiler: {
        logFileIdleThreshold: parseInt(process.env.PROFILER_LOG_FILE_IDLE_THRESHOLD, 10) || 1000 * 60,
    },
    analytics: {
    ...
    logger: {
        ...
        stdout: process.env.STDOUT_LOGGER ? process.env.STDOUT_LOGGER === 'true' : false,
        files: process.env.FILES_LOGGER ? process.env.FILES_LOGGER === 'true' : true,
    ...
    connections: {
        timeout: parseInt(process.env.CONNECTIONS_TIMEOUT_DEFAULT, 10) || 30 * 1000,
    },
    redisStack: {
