...
exports.UTF8FormatterStrategy = void 0;
const lodash_1 = require("lodash");
const cli_helper_1 = require("../../../../../../utils/cli-helper");
class UTF8FormatterStrategy {
    format(reply) {
        if (reply instanceof Buffer) {
            return (0, cli_helper_1.getUTF8FromBuffer)(reply);
        }
...
exports.UTF8FormatterStrategy = UTF8FormatterStrategy;
