...
let ConsumerController = class ConsumerController extends base_controller_1.BaseController {
    constructor(service) {
        super();
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.ClientMetadata,
        stream_dto_1.DeleteConsumersDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, api_redis_instance_operation_decorator_1.ApiRedisInstanceOperation)({
        ...
        responses: [
            {
                status: 200,
                type: stream_dto_1.PendingEntryDto,
                isArray: true,
            },
        ],
    }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.ClientMetadata,
        stream_dto_1.GetPendingEntriesDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, api_redis_instance_operation_decorator_1.ApiRedisInstanceOperation)({
        ...
        responses: [
            {
                status: 200,
                type: stream_dto_1.AckPendingEntriesResponse,
            },
        ],
    }),
    __param(0, (0, browser_client_metadata_decorator_1.BrowserClientMetadata)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.ClientMetadata,
        stream_dto_1.AckPendingEntriesDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, api_redis_instance_operation_decorator_1.ApiRedisInstanceOperation)({
        ...
        responses: [
            {
                status: 200,
                type: stream_dto_1.ClaimPendingEntriesResponse,
            },
        ],
    }),
    __param(0, (0, browser_client_metadata_decorator_1.BrowserClientMetadata)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.ClientMetadata,
        stream_dto_1.ClaimPendingEntryDto]),
    __metadata("design:returntype", Promise)
