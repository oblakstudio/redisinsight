...
const delete_browser_history_dto_1 = require("../../dto/browser-history/delete.browser-history.dto");
const delete_browser_history_response_dto_1 = require("../../dto/browser-history/delete.browser-history.response.dto");
...
__decorate([
    (0, api_endpoint_decorator_1.ApiEndpoint)({
        ...
        responses: [
            {
                status: 200,
                type: get_browser_history_dto_1.BrowserHistory,
            },
        ],
    }),
    (0, common_1.Get)(''),
...
__decorate([
    (0, api_endpoint_decorator_1.ApiEndpoint)({
        ...
        responses: [
            {
                status: 200,
                type: delete_browser_history_response_dto_1.DeleteBrowserHistoryItemsResponse,
            },
        ],
    }),
    (0, api_redis_params_decorator_1.ApiRedisParams)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, delete_browser_history_dto_1.DeleteBrowserHistoryItemsDto]),
    __metadata("design:returntype", Promise)
...
BrowserHistoryController = __decorate([
    ...
    (0, swagger_1.ApiTags)('Browser History'),
