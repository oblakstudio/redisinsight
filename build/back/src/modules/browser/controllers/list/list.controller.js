...
let ListController = class ListController extends base_controller_1.BaseController {
    constructor(listBusinessService) {
        super();
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.ClientMetadata, Number, dto_1.KeyDto]),
    __metadata("design:returntype", Promise)
...
ListController = __decorate([
    ...
    __metadata("design:paramtypes", [list_business_service_1.ListBusinessService])
], ListController);
