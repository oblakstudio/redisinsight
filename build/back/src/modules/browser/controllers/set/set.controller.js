...
let SetController = class SetController extends base_controller_1.BaseController {
    constructor(setBusinessService) {
        super();
        this.setBusinessService = setBusinessService;
    }
...
SetController = __decorate([
    (0, swagger_1.ApiTags)('Set'),
    (0, common_1.Controller)('set'),
    __metadata("design:paramtypes", [set_business_service_1.SetBusinessService])
], SetController);
